...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(E_MODEL_STAR, 9433, -6762, 5510, 0, 0, 0, (1 << 24), id_bhvStar),
		...
		OBJECT_WITH_ACTS(E_MODEL_WHOMP, -5276, -5000, -5720, 0, 0, 0, (0 << 24), id_bhvWhompKingBoss, ACT_1),
		...
		OBJECT(E_MODEL_BOWLING_BALL, 7172, -8313, 6455, 0, 180, 0, 0x00000000, id_bhvBobBowlingBallSpawner),
		OBJECT(E_MODEL_BOWLING_BALL, -6416, -4945, -4923, 0, 135, 0, 0x00000000, id_bhvBobBowlingBallSpawner),
		OBJECT(E_MODEL_BOWLING_BALL, -6172, -4945, -6676, 0, 49, 0, 0x00000000, id_bhvBobBowlingBallSpawner),
		MARIO_POS(0x01, 0, 914, -9536, 2185),
		OBJECT(MODEL_NONE, 914, -9536, 2185, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
